            ...
            <div className="flex gap-y-10 gap-x-5 p-7 mx-10 mr-0 w-full overflow-auto">
              <div style={{ maxWidth: "1900" }}>
                <div>
                  ...
                  ></iframe>
                  <div className="mt-5">
                    <p className="text-3xl">{currentPlaying.videoTitle}</p>
                    ...
                    <div className="flex gap-4 flex-col border-solid border-gray-400 border-2 my-5 pb-3 border-l-transparent border-r-transparent">
                      <div className="flex items-center gap-5 mr-5 mt-4">
                        ...
                        <div>
                          <button className="uppercase bg-red-600 rounded-sm p-2 text-xl tracking-wider">
                            subscribe
                          </button>
                        </div>
                      </div>
                      ...
                      <div>
                        <button
                          className="uppercase text-md cursor-pointer"
